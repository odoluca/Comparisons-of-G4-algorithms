...
quadparserCommand = 'python G4-predictorModified.py -w 25 -s 1.7 '  # shell command for quadparser command
# quadparserCommand = 'python G4-predictorModified.v2b.py -w 25 -s 1.7 '  # shell command for quadparser command
