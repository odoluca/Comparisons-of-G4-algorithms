...
def constructRegex(parametersList):
  ...
  # quadparserCommand = 'python ImGQfinder.v2.py --noreverse -r "( [G]{'+str(ifull)+',} | (?P<mis>           ([G]{'+str(ilong)+',}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{'+str(ilong)+',})))  ( ((\w{1,'+str(iloop)+'})|(?P<lloop>\w{1,'+str(eloop)+'}) )  (?(mis)[G]{'+str(ifull)+',}| ([G]{'+str(ifull)+',}|(?P<mis>([G]{'+str(ilong)+',}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{'+str(ilong)+',})))))  ( (?(lloop)\w{1,'+str(iloop)+'}|(?P<lloop>\w{1,'+str(ilong)+'}) )  (?(mis)[G]{'+str(ifull)+',}| ([G]{'+str(ifull)+',}|(?P<mis>([G]{'+str(ilong)+',}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{'+str(ilong)+',})))))  ((?(lloop)\w{1,'+str(iloop)+'}|(?P<lloop>\w{1,'+str(ilong)+'}) )   (?(mis)[G]{'+str(ifull)+',}| ([G]{'+str(ifull)+',}|(?P<mis>([G]{'+str(ilong)+',}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{'+str(ilong)+',}))) ))+" '  # status for reference dataset: MCC:0.809, precision 95.0%
    quadparserCommand = 'python ImGQfinder.v2.py --noreverse -r "( [G]{'+str(ilong)+',} | (?P<imperfectTract>([G]{'+str(ilong)+',}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{'+str(ilong)+',})))(((\w{'+str(mloop-iloop)+','+str(mloop)+'})|(?P<ExtremeLoop>\w{1,'+str(eloop)+'}))(?(imperfectTract)([G]{'+str(mfull)+',})|([G]{'+str(mfull)+',}|(?P<imperfectTract>([G]{'+str(mlong)+',}[AUTC][G]{1,}|[G]{'+str(mshort)+',}[AUTC][G]{'+str(mlong)+',})))))((?(ExtremeLoop)\w{'+str(mloop-iloop)+','+str(mloop)+'}|(\w{'+str(mloop-iloop)+','+str(mloop)+'}|(?P<ExtremeLoop>\w{1,'+str(eloop)+'})))(?(imperfectTract)([G]{'+str(mfull)+',})|([G]{'+str(mlong)+',}|(?P<imperfectTract>([G]{'+str(mfull)+',}[AUTC][G]{'+str(mshort)+',}|[G]{'+str(mshort)+',}[AUTC][G]{'+str(mlong)+',})))))((?(ExtremeLoop)\w{'+str(mloop-iloop)+','+str(mloop)+'}|(\w{'+str(mloop-iloop)+','+str(mloop)+'}|(?P<ExtremeLoop>\w{1,'+str(eloop)+'})))(?(imperfectTract)([G]{'+str(efull)+',})|([G]{'+str(elong)+',}|(?P<imperfectTract>([G]{'+str(elong)+',}[AUTC][G]{'+str(eshort)+',}|[G]{'+str(eshort)+',}[AUTC][G]{'+str(elong)+',})))))"'  # status for reference dataset: MCC:0.849 precision 95.1% #has too short limitation as well for loops
    test='"( [G]{3,} | (?P<imperfectTract>([G]{3,}[AUTC][G]{'+str(ishort)+',}|[G]{'+str(ishort)+',}[AUTC][G]{3,})))(((\w{'+str(mloop-iloop)+',4})|(?P<ExtremeLoop>\w{1,34}))(?(imperfectTract)([G]{1,})|([G]{1,}|(?P<imperfectTract>([G]{2,}[AUTC][G]{'+str(mshort)+',}|[G]{'+str(mshort)+',}[AUTC][G]{2,})))))((?(ExtremeLoop)\w{'+str(mloop-iloop)+',4}|(\w{'+str(mloop-iloop)+',4}|(?P<ExtremeLoop>\w{1,34})))(?(imperfectTract)([G]{1,})|([G]{2,}|(?P<imperfectTract>([G]{1,}[AUTC][G]{1,}|[G]{1,}[AUTC][G]{2,})))))((?(ExtremeLoop)\w{'+str(mloop-iloop)+',4}|(\w{'+str(mloop-iloop)+',4}|(?P<ExtremeLoop>\w{1,34})))(?(imperfectTract)([G]{3,})|([G]{'+str(elong)+',}|(?P<imperfectTract>([G]{'+str(elong)+',}[AUTC][G]{'+str(eshort)+',}|[G]{'+str(eshort)+',}[AUTC][G]{'+str(elong)+',})))))"'  # status for reference dataset: MCC:0.849 precision 95.1% #has too short limitation as well for loops
    test='"( [G]{3,} | (?P<imperfectTract>([G]{3,}[AUTC][G]{2,}|[G]{2,}[AUTC][G]{3,})))(((\w{0,4})|(?P<ExtremeLoop>\w{1,34}))(?(imperfectTract)([G]{1,})|([G]{1,}|(?P<imperfectTract>([G]{2,}[AUTC][G]{1,}|[G]{1,}[AUTC][G]{2,})))))((?(ExtremeLoop)\w{0,4}|(\w{0,4}|(?P<ExtremeLoop>\w{1,34})))(?(imperfectTract)([G]{1,})|([G]{2,}|(?P<imperfectTract>([G]{1,}[AUTC][G]{1,}|[G]{1,}[AUTC][G]{2,})))))((?(ExtremeLoop)\w{0,4}|(\w{0,4}|(?P<ExtremeLoop>\w{1,34})))(?(imperfectTract)([G]{3,})|([G]{2,}|(?P<imperfectTract>([G]{2,}[AUTC][G]{1,}|[G]{1,}[AUTC][G]{2,})))))"'  # status for reference dataset: MCC:0.849 precision 95.1% #has too short limitation as well for loops
